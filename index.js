...
async function run() {
    try {
        ...
        const proCoursesCollection = client.db("IPTMIT_INFO").collection("PROFESSIONAL_INFO");
        ...
        app.put('/professional-course/:id', async (req, res) => {
            ...
            const result = await proCoursesCollection.updateOne(filter, updateDoc, options);
            res.send(result);
        })
        ...
        app.put('/about-info/:id', async (req, res) => {
            ...
            const result = await aboutCollection.updateOne(filter, updateAboutDoc, options);
            res.send(result)
        })
        ...
        const managementCollection = client.db("IPTMIT_INFO").collection("MANAGEMENT_INFO");
        ...
        app.put('/management-info/:id', async (req, res) => {
            ...
            const result = await managementCollection.updateOne(filter, updateDoc, options);
            res.send(result);
        })
        ...
        app.put('/admin-info/:id', async (req, res) => {
            ...
            const result = await adminInfoCollection.updateOne(filter, updateAdminDoc, options);
            res.send(result)
        })
